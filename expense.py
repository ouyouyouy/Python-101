...
def writecsv(data):
    with open('dat.csv','a',newline='',encoding='utf-8') as file:
        fw = csv.writer(file)
        fw.writerow(data)
...
def readcsv():
    with open('dat.csv',newline='',encoding='utf-8') as file:
...
############################################################
icon = 'C:\\Users\\ouyna\\Desktop\\python for everyone\\wallet.png'
